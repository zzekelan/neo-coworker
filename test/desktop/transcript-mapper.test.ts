...
describe("desktop transcript mapper", () => {
  ...
  test("maps structured lifecycle parts without parsing tool labels", () => {
    const message: DesktopMessage = {
      ...
      parts: [
        {
          id: "part-lifecycle-agent-started",
          sessionId: "session-1",
          runId: "run-1",
        ...
        {
          id: "part-lifecycle-skill-failed",
          sessionId: "session-1",
          runId: "run-1",
          messageId: "message-lifecycle-1",
          kind: "lifecycle",
          ...
          data: {
            ...
            errorMessage: "No builtin source-note skill was found",
            reason: "required by source researcher",
          },
          createdAt: 1_710_000_006_100,
        },
      ],
    }

    expect(mapTranscriptMessage(message).parts).toEqual([
      {
        type: "lifecycle",
