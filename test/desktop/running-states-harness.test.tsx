...
describe("desktop running states harness", () => {
  ...
  test("keeps each long-running visual state available as a stable scenario", () => {
    ...
    expect(harnessSource).not.toContain('"thinking"')
  ...
  test("adds a focused activity details fixture for scrolling reasoning and tool details", () => {
    ...
    expect(harnessSource).toContain("setPhase(\"tool-running\")")
    expect(harnessSource).toContain("setPhase(\"next-reasoning\")")
    expect(harnessSource).toContain("ACTIVITY_TOOL_RUNNING_HOLD_MS")
    ...
    expect(harnessSource).toContain("activity-browser-call")
    expect(harnessSource).toContain("ACTIVITY_REASONING_DURATION_MS")
    expect(harnessSource).toContain("activeRun: run")
