...
Use this skill to convert source notes into durable findings.

## Workflow

1. Start from source notes, not memory alone.
2. Write one testable claim per finding.
3. Set scope before confidence so limits are explicit.
